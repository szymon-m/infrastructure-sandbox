...
# move config files from vagrant home to /etc (during provisioning via config provisioner "file" vagrant user dont have sufficent permission to place files in /etc)
